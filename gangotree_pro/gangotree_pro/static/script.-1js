...
const programData = {
  disabled: {
    ...
    gallery: [
      { src: 'https://gangotree.org/program_activity/21-sports competion among desabled at jajpur.jpg', caption: 'Sports for Disabled Children at Jajpur' },
      { src: 'https://gangotree.org/program_activity/22-WhatsApp Image 2024-01-13 at 9.53.27 AM (1).jpg', caption: 'Working for Senior Citizens' },
      { src: 'https://gangotree.org/program_activity/23-Draqwing competition among disabled children.jpg', caption: 'Drawing Competition for Disabled Students' },
      { src: 'https://gangotree.org/program_activity/28-DSC03676.jpg', caption: 'Activities for Disabled' },
    ],
  },
  carbon: {
    ...
    gallery: [
      { src: 'carbon-1.jpeg', caption: 'Carbon Farming Field Activity' },
      { src: 'carbon-2.jpeg', caption: 'AWD Pipe Demonstration' },
      { src: 'carbon-3.jpeg', caption: 'Carbon Farming Training' },
      { src: 'https://gangotree.org/program_activity/14-6-1.jpg', caption: 'Carbon Farming Programme' },
      { src: 'https://gangotree.org/program_activity/19-WhatsApp Image 2024-02-03 at 6.46.51 PM (1) (1).jpg', caption: 'AWD Pipe Demonstration by Farmer' },
      { src: 'https://gangotree.org/program_activity/30-DSC_5186.jpg', caption: 'Workshop on Carbon Farming' },
      { src: 'https://gangotree.org/program_activity/32-DSC_5242.jpg', caption: 'Farmers Registration' },
      { src: 'https://gangotree.org/program_activity/29-DSC_5226.jpg', caption: 'Evaluation Visit' },
      { src: 'https://gangotree.org/program_activity/18-IMG_20230414_093555.jpg', caption: 'Geo-tagging of Carbon Farming' },
    ],
  },
  trai: {
    ...
    gallery: [
      { src: 'consumer.jpeg', caption: 'Consumer Rights Awareness Programme' },
      { src: 'https://gangotree.org/program_activity/20-Baliguda-02.jpg', caption: 'Telecom Awareness Meeting — Baliguda' },
      { src: 'WhatsApp_Image_2026-04-30_at_12_14_31_PM.jpeg', caption: 'TRAI Awareness Workshop' },
      { src: 'WhatsApp_Image_2026-04-30_at_12_14_32_PM.jpeg', caption: 'Digital Literacy Session' },
    ],
  },
  textile: {
    ...
    gallery: [
      { src: 'women-empower.jpeg', caption: 'Women Empowerment — Artisan Training' },
      { src: 'women-empower-2.jpeg', caption: 'Women Artisans Workshop' },
      { src: 'https://gangotree.org/program_activity/13-WhatsApp Image 2024-01-08 at 3.58.45 PM.jpg', caption: 'Stone Carving Programme' },
      { src: 'https://gangotree.org/program_activity/34-WhatsApp Image 2024-01-08 at 3.58.44 PM (2).jpg', caption: 'Stone Carving Skill Training' },
      { src: 'https://gangotree.org/program_activity/35-WhatsApp_Image_2024-03-13_at_13.57.25.jpg', caption: 'Textile Skill Development' },
      { src: 'https://gangotree.org/program_activity/36-WhatsApp Image 2024-03-31 at 7.45.15 PM (2).jpg', caption: 'Artisan Showcase' },
    ],
  },
  nutrition: {
    ...
    gallery: [
      { src: 'https://gangotree.org/program_activity/11-WhatsApp Image 2024-02-13 at 1.20.04 PM (1).jpg', caption: 'Pre-school Nutrition Programme' },
      { src: 'https://gangotree.org/program_activity/27-milk distribution at kumbharasahi.jpg', caption: 'Milk Distribution at Kumbharasahi' },
      { src: 'https://gangotree.org/program_activity/38-IMG_20230323_131641 (1).jpg', caption: 'Nutrition Support Distribution' },
      { src: 'https://gangotree.org/program_activity/25-RAHAT support ot benificaiary.jpg', caption: 'RAHAT Support to Beneficiaries' },
      { src: 'https://gangotree.org/program_activity/40-WhatsApp Image 2023-03-21 at 10.06.18 PM.jpg', caption: 'RAHAT Support to Vulnerable Families' },
      { src: 'https://gangotree.org/program_activity/41-WhatsApp Image 2024-02-13 at 1.21.56 PM.jpg', caption: 'Milk Distribution at Salijanga GP' },
    ],
  },
  agriculture: {
    title: 'Agriculture',
    ...
    gallery: [
      { src: 'WhatsApp_Image_2026-04-30_at_12_14_31_PM.jpeg', caption: 'Farmer Training Session' },
      { src: 'WhatsApp_Image_2026-04-30_at_12_14_32_PM.jpeg', caption: 'Field Demonstration — Kayan' },
      { src: 'https://gangotree.org/program_activity/12-WhatsApp Image 2023-11-16 at 4.20.28 PM (2).jpg', caption: 'CDP-MLIP Programme' },
      { src: 'https://gangotree.org/program_activity/16-WhatsApp Image 2023-08-24 at 4.47.00 PM.jpg', caption: 'CDP-MLIP Field Activity' },
      { src: 'https://gangotree.org/program_activity/17-Irrigation points joint visit.jpg', caption: 'Joint Visit with Govt Staff — Irrigation' },
      { src: 'https://gangotree.org/program_activity/44-WhatsApp Image 2023-11-01 at 5.24.39 PM.jpg', caption: 'Farmers Meeting under CDP-MLIP' },
      { src: 'https://gangotree.org/program_activity/43-WhatsApp Image 2024-03-06 at 10.24.52 PM.jpg', caption: 'Cooking Competition — Community Event' },
      { src: 'https://gangotree.org/program_activity/45-WhatsApp Image 2024-03-11 at 3.42.56 PM (1).jpg', caption: 'Prize Distribution Ceremony' },
      { src: 'https://gangotree.org/gallery/8-AWD pipe demonstration by a Farmer at Enaadarei (1).jpg', caption: 'AWD Pipe Demonstration at Enaadarei' },
    ],
  },
};
...
function proceedDonate() {
  ...
  if (!amount || amount <= 0) {
    ...
    setTimeout(() => (document.querySelector('.amount-grid').style.outline = ''), 2000);
    return;
  }
